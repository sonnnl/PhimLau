      ...
      <VStack spacing={8} align="stretch">
            ...
            >
              ...
              >
                ...
                <HStack spacing={4} wrap="wrap">
                  ...
                  <Badge
                    colorScheme={
                      profileData.user.role === "admin" ? "purple" : "blue"
                    }
                  >
        ...
        <SimpleGrid columns={{ base: 1, md: 4 }} spacing={6}>
          <Card bg="background.secondary">
            <CardBody>
              <Stat>
                <StatLabel>Tổng đánh giá</StatLabel>
                <StatNumber color="brand.accent">
                  {profileData.stats?.totalReviews || 0}
                </StatNumber>
                <StatHelpText>Đánh giá phim</StatHelpText>
              </Stat>
            </CardBody>
          </Card>
          <Card bg="background.secondary">
            <CardBody>
              <Stat>
                <StatLabel>Bài viết Forum</StatLabel>
                <StatNumber color="brand.accent">
                  {profileData.stats?.totalThreads || 0}
                </StatNumber>
                <StatHelpText>Chủ đề tạo</StatHelpText>
              </Stat>
            </CardBody>
          </Card>
          <Card bg="background.secondary">
            <CardBody>
              <Stat>
                <StatLabel>Trả lời Forum</StatLabel>
                <StatNumber color="brand.accent">
                  {profileData.stats?.totalReplies || 0}
                </StatNumber>
                <StatHelpText>Phản hồi</StatHelpText>
              </Stat>
            </CardBody>
          </Card>
          <Card bg="background.secondary">
